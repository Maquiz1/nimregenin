...
WHERE t1.status = '1' AND t1.site_id = '$site'  AND t2.expected_date <= '$date' AND t2.visit_code = 'M6'");
    ...
    {
        $query = $this->_pdo->query("SELECT `study_id`,`id_number`,`firstname`,`middlename`,`lastname`,`screened`,`eligibility1`,`eligibility2`,`eligible`,`enrolled`,`site_id`,`status` FROM `clients` WHERE `status`=1  AND `screened`=1 AND `eligible`=1 AND `site_id`='$value' ORDER BY `site_id`
");
        $num = $query->rowCount();
        return $num;      
...
");
    ...
    {
        $query = $this->_pdo->query("SELECT `study_id`,`id_number`,`firstname`,`middlename`,`lastname`,`screened`,`eligibility1`,`eligibility2`,`eligible`,`enrolled`,`site_id`,`status` FROM `clients` WHERE `status`=1  AND `screened`=1 AND `eligible`=1 AND `enrolled`=1 AND `site_id`='$value' ORDER BY `site_id`");
        $num = $query->rowCount();
        return $num;       
    ...
    {
        $query = $this->_pdo->query("SELECT `study_id`,`id_number`,`firstname`,`middlename`,`lastname`,`screened`,`eligibility1`,`eligibility2`,`eligible`,`enrolled`,`site_id`,`status` FROM `clients` WHERE `status`=1  AND `screened`=1 AND `eligible`=1 AND (`enrolled`=0 OR `enrolled`=2) AND `site_id`='$value' ORDER BY `site_id`");
        $num = $query->rowCount();
        return $num;      
    ...
    {
        $query = $this->_pdo->query("SELECT `study_id`,`id_number`,`firstname`,`middlename`,`lastname`,`screened`,`eligibility1`,`eligibility2`,`eligible`,`enrolled`,`site_id`,`status` FROM `clients` WHERE `status`=1 AND `screened`=1 AND `site_id`='$value' ORDER BY `site_id`");
        $num = $query->rowCount();
        return $num;      
    ...
    {
        $query = $this->_pdo->query("SELECT `study_id`,`id_number`,`firstname`,`middlename`,`lastname`,`screened`,`eligibility1`,`eligibility2`,`eligible`,`enrolled`,`site_id`,`status` FROM `clients` WHERE `status`=1 AND `screened`=1 AND (`eligible`=0 OR `eligible`=2) AND `site_id`='$value' ORDER BY `site_id`");
        $num = $query->rowCount();
        return $num;      
