                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <!-- filepath: /var/www/html/nimregenin/add.php -->
                                    <form id="crf3" method="post">
                                        <div class="card card-primary">
                                            <div class="card-header">
                                                <h3 class="card-title">CRF3 Form</h3>
                                            </div>
                                            <div class="card-body">
                                                <!-- Date Section -->
                                                <div class="form-group">
                                                ...
                                                <div class="card card-info">
                                                    <div class="card-header">
                                                        <h3 class="card-title">Clinical Symptoms</h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="symptoms_other_specify">U. Specify:</label>
                                                                    <input type="text" class="form-control" name="symptoms_other_specify" id="symptoms_other_specify" value="<?= $patient['symptoms_other_specify'] ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!-- Add more rows for other symptoms as needed -->
                                                    </div>
                                                </div>
                                                ...
                                                <?php if (!$_GET['vcode'] == "D0") { ?>
                                                    <div class="card card-info">
                                                        <div class="card-header">
                                                            <h3 class="card-title">Drug Adherence (To be asked on day 7, 14, 30, 60, 90, 120) For patients on NIMREGENIN only</h3>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label for="adherence_specify">1. Specify why:</label>
                                                                        <input type="text" class="form-control" name="adherence_specify" id="adherence_specify" value="<?= $patient['adherence_specify'] ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <!-- Patients Not on NIMREGENIN Section -->
                                                <div class="card card-warning">
                                                    <div class="card-header">
                                                        <h3 class="card-title">For Patients Not on NIMREGENIN</h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="herbal_ingredients">Specify type by name or ingredients:</label>
                                                            <input type="text" class="form-control" name="herbal_ingredients" id="herbal_ingredients" value="<?= $patient['herbal_ingredients'] ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="other_comments" id="other_comments" value="<?= $patient['other_comments'] ?>">
                                                </div>
                                    ...
                                    <form id="crf4" method="post">
                                        ...
                                        <div class="card card-primary">
                                            ...
                                            <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control" name="liver_pt" id="liver_pt" value="<?= $patient['liver_pt'] ?>" />
                                                                        <div class="input-group-append">
                                                                            <span class="input-group-text">units/L</span>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control" name="liver_ptt" id="liver_ptt" value="<?= $patient['liver_ptt'] ?>">
                                                                        <div class="input-group-append">
                                                                            <span class="input-group-text">units/L</span>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <input type="text" class="form-control" name="liver_inr" id="liver_inr" value="<?= $patient['liver_inr'] ?>">
                                                                        <div class="input-group-append">
                                                                            <span class="input-group-text">units/L</span>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group" style="border: 1px solid #ddd; padding: 10px; margin-bottom: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="input-group-append">
                                                                            <select class="form-control select2" name="liver_bilirubin_total_units" required>
                                                                                <option value="">Select Units</option>
                                                                                <option value="1" <?= $patient['liver_bilirubin_total_units'] == "1" ? "selected" : "" ?>>micromol/L</option>
                                                                                <option value="2" <?= $patient['liver_bilirubin_total_units'] == "2" ? "selected" : "" ?>>mg/dL</option>
                                                                                <option value="3" <?= $patient['liver_bilirubin_total_units'] == "3" ? "selected" : "" ?>>grams/L</option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                    <div class="input-group mt-1">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <div class="input-group-append">
                                                                            <select class="form-control select2" name="liver_bilirubin_direct_units" id="liver_bilirubin_direct_units" style="width: 100%;" required>
                                                                                <option value="">Select Units</option>
                                                                                <option value="1" <?= $patient['liver_bilirubin_direct_units'] == "1" ? "selected" : "" ?>>micromol/l</option>
                                                                                <option value="2" <?= $patient['liver_bilirubin_direct_units'] == "2" ? "selected" : "" ?>>mg/dl</option>
                                                                                <option value="3" <?= $patient['liver_bilirubin_direct_units'] == "3" ? "selected" : "" ?>>grams/L</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="input-group-append">
                                                ...
                                                <div class="card card-secondary">
                                                    <div class="card-header">
                                                        <h3 class="card-title">3. Full blood count</h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-3">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group" style="border: 1px solid #ddd; padding: 10px; margin-bottom: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input value="<?= $patient['chest_specify'] ?>" type="text" name="chest_specify" class="form-control" placeholder="Specify (Report from Radiologist)" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group" style="border: 1px solid #ddd; padding: 10px; margin-bottom: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input value="<?= $patient['ct_chest_specify'] ?>" type="text" name="ct_chest_specify" class="form-control" placeholder="Specify (Report from Radiologist)" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="form-group" style="border: 1px solid #ddd; padding: 10px; margin-bottom: 10px;">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input value="<?= $patient['ultrasound_specify'] ?>" type="text" name="ultrasound_specify" class="form-control" placeholder="Specify (Report from Radiologist)" />
                                                                    </div>
                                                                </div>
                                                            </div>
